...
Usage:
    ...
    # Get all packs feeding Layer 2.5
    l25_packs = get_packs_for_layer('L2.5')

    # Score text against packs
    results = score_packs(text, l25_packs)
...
class LexiconPack:
    ...
    Attributes:
        ...
        target_layer: Which pipeline layer consumes this ('L2.5', 'L2.6',
                      'L2.7', 'L3.0', 'multi')
...
def compute_pack_enhanced_cfd(text: str, n_sentences: int,
    ...
    """Compute pack-enhanced Constraint Frame Density for Layer 2.5.
    ...
    """
    constraint_packs = get_packs_for_layer('L2.5')
...
def compute_pack_enhanced_idi(text: str, n_words: int,
    ...
    """Compute pack-enhanced IDI for Layer 2.7.
    ...
    """
    idi_packs = get_packs_for_layer('L2.7')
